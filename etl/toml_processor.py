...
from etl.path_helpers import (get_archive_path, get_error_path, get_inbox_path,
                              get_processing_path)
...
class TOMLProcessor:
    ...
    def __init__(self):
        ...
        for obj in self._object_store.list_objects(settings.minio_etl_bucket,
                                                   None,
                                                   recursive=True):
    ...
    def _toml_put(self, toml_object_id: ObjectId) -> bool:
        ...
        try:
            ...
            if cfg.enabled:
                ...
                self.logger.info('number of processor configs: %s',
                                 len(self.processors))
